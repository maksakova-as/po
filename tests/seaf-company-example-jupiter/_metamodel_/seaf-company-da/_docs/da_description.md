...
В составе корпоративной архитектуры компании, Архитектура Данных (АД) является вертикалью, проходящей сквозь и соединяющейся со следующими слоями корпоративной архитектуры:

- Бизнес Архитектурой (БА);
- Прикладной Архитектурой (ПА).

Принцип ведения АД в составе корпоративной архитектуры.
При ведении АД в компании, необходимо заполнять все слои АД для корректности встраивания в корпоративную архитектуру и связанности слоёв внутри информационной архитектуры.
При отсутствии слоя в АД, он используется как прокси уровень, и заполняется однозначным маппингом с более нижнего уровня (при наличии).
...
Сущность в SEAF ArchTool: seaf.company.da.aggregatst

Мета атрибуты|Значения
:------------  | :------------
Код|_ code _
Наименование|_title_
Описание|_description_
Уровень агрегации|_type_
Проектировщик (ФИО)|_owner_
Владелец (Функциональный блок)|_unit_
Комментарий|_comments_
Содержимое|array: [_aggregat_]
...
Сущность в SEAF ArchTool: seaf.company.da.business_terms
...
Описание|_description_
Статус|_status_
Дата внесения термина|_creation_date_
Дата изменения термина|_modify_date_
Ответственный (ФИО)|_owner_
Комментарий|_comments_
Нормативный/правовой документ|_legal_doc_
...
- логическая сущность (Логическая сущность);
...
Логическая сущность является центральной сущностью АД и обеспечивает:
...
- распределение всей АД компании на области, посредством включения в Агрегаты (мета атрибут «Агрегат»);
- связь с Бизнес-глоссарием АД, посредством ссылок на бизнес-термины (мета атрибут «Бизнес-термины»);
- связь с Физической Моделью АД, через ссылки из объектов Физических таблиц;
...
Сущность в SEAF ArchTool: seaf.company.da.logical_entities
...
Статус|_status_
Агрегат|_aggregat_
Категория|_category_
Наличие персональных данных|_pdn_flag_
Наличие критических данных|_cde_flag_
Мастер система|_master_system_
Комментарии|_comments_
Бизнес-термины|array: [_business_terms_]
...
Логический атрибут имеет однозначную прямую связь с бизнес уровнем АД, через мета атрибут «Бизнес-термин», посредством ссылки на конкретный бизнес-термин.

Сущность в SEAF ArchTool: seaf.company.da.logical_attributes
...
Наличие персональных данных|_pdn_flag_
Наличие критических данных|_cde_flag_
Логическая сущность|_logical_entity_
Бизнес-термин|_business_term_
...
Сущность в SEAF ArchTool: seaf.company.da.logical_links
...
Статус|_status_
Описание|_description_
Сущность А|_entity_a_
Множественность A|_multiplicity_a_
Тип связи|_link_type_
Сущность В|_entity_b_
Множественность B|_multiplicity_b_
Направления связи|_ visual_style_
...
Сущность в SEAF ArchTool: seaf.company.da.physical_tables

Мета атрибуты|Значения
:------------  | :------------
Наименование|_title_
Статус|_status_
Тип представления|_type_
Описание|_description_
Автоматизированная система|_system_
СУБД|_dbms_
База данных|_database_
Схема|_schema_name_
Локационные атрибуты|array: [_loc_attr_]
Количество строк|_rows_count_
Количество столбцов|_cols_count_
Наличие персональных данных|_pdn_flag_
Наличие критических данных|_cde_flag_
...
Сущность в SEAF ArchTool: seaf.company.da.physical_attributes
...
Наличие персональных данных|_pdn_flag_
Наличие критических данных|_cde_flag_
Флаг PRIMARY KEY|_pk_flag_
Флаг FOREIGN KEY|_fk_flag_
Физическая таблица|_physical_table_
Связанная таблица|_linked_table_
Ключ в связанной таблице|_linked_key_
